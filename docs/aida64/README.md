...
4. Use the sanitized summary to update `README.md`, `docs/machines/g3rog-dark/specs/`, `docs/machines/g3rog-dark/bios-settings.md`, and `docs/machines/g3rog-dark/validation/`.

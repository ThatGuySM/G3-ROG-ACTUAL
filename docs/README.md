...
- [Current system health report](g3ROG-actual_System_Health_Report.md)
- [Current PDF report](g3ROG-actual_System_Health_Report.pdf)
...
- `g3ROG-actual_Battlestation_Spec_Sheet.md` is the single published hardware inventory for the repo.
